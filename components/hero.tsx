...
function Hero() {
  return (
    <section className="relative h-[128vh] md:h-screen">
      ...
      <div className="px-8 md:px-28 py-24 md:py-0 absolute top-0 left-0 text-white w-full h-full flex flex-col md:flex-row justify-between items-center gap-12">
